...
const Songs = [
  {
    ...
    songName: "Bella Ciao",
    artist: "El Profesor",
    song: require("../songs/Bella_Ciao.mp3"),
    imgSrc: require("../img/Bella_ciao.jpg"),
  },
  {
    id: 2,
    favourite: false,
    songName: "Beast",
    artist: "Anirudh Ravichander",
    song: require("../songs/beast.mp3"),
    imgSrc: require("../img/beast.jpg"),
  },
  {
    id: 3,
    favourite: false,
    songName: "Joker - Rock and Roll",
    artist: "Hildur Guðnadóttir",
    song: require("../songs/rock_and_roll.mp3"),
    imgSrc: require("../img/Joker.jpg") ,
  },
  {
    id: 4,
    favourite: false,
    songName: "I Am A Peaky Blinder",
    artist: "Otnicka",
    song: require("../songs/peaky_blinder.mp3"),
    imgSrc: require("../img/Peaky.jpg"),
  },
  {
    id: 5,
    favourite: false,
    songName: "Naanga Vera Maari",
    artist: "Yuvan Shankar Raja",
    song: require("../songs/vera_maari.mp3"),
    imgSrc: require( "../img/Vera_mari.jpg"),
  },
  {
    id: 6,
    favourite: false ,
    songName: "Your Woman",
    artist: "White Town",
    song: require("../songs/your_woman.mp3"),
    imgSrc: require("../img/Your_woman.jpg"),
  },
  {
    id: 7,
    favourite: false,
    songName: "Charlie",
    artist: "Gopi Sundar",
    song: require("../songs/charlie.m4a"),
    imgSrc: require("../img/Charlie.jpg"),
  },
  {
    id: 8,
    favourite: false,
    songName: "Mask Off",
    artist: "Future",
    song: require("../songs/Mask_Off.mp3"),
    imgSrc: require("../img/Mask_Off.jpg"),
  },
  {
    id: 9,
    favourite: false,
    songName: "Hey Mama",
    artist: "David Guetta",
    song: require("../songs/Heymama.mp3"),
    imgSrc: require("../img/Heymama.jpg"),
  },
  {
    id: 10,
    favourite: false,
    songName: "Turkish Folk Battle Song",
    artist: "CVR Toon ",
    song: require("../songs/tukish_folk_battle.mp3"),
    imgSrc: require("../img/Battle_song.jpg") ,
  },
];
